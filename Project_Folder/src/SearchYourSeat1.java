...
public class SearchYourSeat1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String query="Select Aadhar_card,Name,Mob_no,Seat_type,date_of_match,Venue,team_1,Team_2,extra_facilities,seat_fees,extra_facilities_bill,Total_fees,Payment_Type,other_offer from stadium where Aadhar_card="+aadhar+";";
            ...
            while(rs.next())
            {
                ...
                String extrafacilities=rs.getString("Extra_Facilities");
                int seatfees=Integer.parseInt(rs.getString("Seat_Fees"));
                int Extb=Integer.parseInt(rs.getString("Extra_Facilities_Bill"));
